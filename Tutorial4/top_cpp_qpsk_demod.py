...
class top_cpp_qpsk_demod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Top Cpp Qpsk Demod")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Top Cpp Qpsk Demod")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "top_cpp_qpsk_demod")
        ...
        # Connections
        ##################################################
        self.connect((self.GNU_tutorials_my_qpsk_demod_cb_0, 0), (self.blocks_uchar_to_float_0, 0))    
        self.connect((self.analog_noise_source_x_0, 0), (self.blocks_add_xx_0, 1))    
        self.connect((self.analog_random_source_x_0, 0), (self.digital_chunks_to_symbols_xx_0, 0))    
        self.connect((self.blocks_add_xx_0, 0), (self.GNU_tutorials_my_qpsk_demod_cb_0, 0))    
...
def main(top_block_cls=top_cpp_qpsk_demod, options=None):

...
# Title: tags_propagation
# Generated: Thu Jul 14 13:17:28 2016
##################################################
...
class tags_propagation(gr.top_block, Qt.QWidget):
...
def main(top_block_cls=tags_propagation, options=None):

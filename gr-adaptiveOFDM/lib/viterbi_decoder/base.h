 ...
 */
#ifndef INCLUDED_ADAPTIVEOFDM_VITERBI_DECODER_BASE_H
#define INCLUDED_ADAPTIVEOFDM_VITERBI_DECODER_BASE_H
...
#endif /* INCLUDED_ADAPTIVEOFDM_VITERBI_DECODER_BASE_H */

...
'''
This is the GNU Radio ADAPTIVEOFDM module. Place your Python package
description here (python/__init__.py).
'''

# import swig generated symbols into the adaptiveOFDM namespace
try:
	# this might fail if the module is python-only
	from adaptiveOFDM_swig import *
except ImportError:
	pass

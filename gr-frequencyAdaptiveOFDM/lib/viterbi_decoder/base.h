 ...
 */
#ifndef INCLUDED_FREQUENCYADAPTIVEOFDM_VITERBI_DECODER_BASE_H
#define INCLUDED_FREQUENCYADAPTIVEOFDM_VITERBI_DECODER_BASE_H
...
#endif /* INCLUDED_FREQUENCYADAPTIVEOFDM_VITERBI_DECODER_BASE_H */

 ...
 */
#ifndef INCLUDED_FREQUENCYADAPTIVEOFDM_VITERBI_DECODER_GENERIC_H
#define INCLUDED_FREQUENCYADAPTIVEOFDM_VITERBI_DECODER_GENERIC_H
...
#endif /* INCLUDED_FREQUENCYADAPTIVEOFDM_VITERBI_DECODER_GENERIC_H */
